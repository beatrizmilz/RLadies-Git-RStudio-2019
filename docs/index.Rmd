...
- Uma página do GitHub irá abrir, com as configurações necessárias. Crie o novo token.
...
```{r echo=TRUE, eval=FALSE}
usethis::create_from_github("rstudio-education/remaster-the-tidyverse",
                   destdir = "C:/Users/beatr/Documents/GitHub",
                   fork = TRUE)
# Creating 'C:/Users/beatr/Documents/GitHub/remaster-the-tidyverse/'
# ✔ Forking 'rstudio-education/remaster-the-tidyverse'
# Which git protocol to use? (enter 0 to exit) 
# 
# 1: ssh   <-- presumes that you have set up ssh keys
{{# 2: https <-- choose this if you don't have ssh keys (or don't know if you do)}}
...
#   in your script or in a user- or project-level startup file, '.Rprofile'.
#   Call `usethis::edit_r_profile()` to open it for editing.
# ✔ Cloning repo from 'https://github.com/beatrizmilz/remaster-the-tidyverse.git' into 'C:/Users/beatr/Documents/GitHub/remaster-the-tidyverse'
# ✔ Setting active project to 'C:/Users/beatr/Documents/GitHub/remaster-the-tidyverse'
# ✔ Adding 'upstream' remote: 'https://github.com/rstudio-education/remaster-the-tidyverse.git'
...
# ✔ Opening 'C:/Users/beatr/Documents/GitHub/remaster-the-tidyverse/' in new RStudio session
...
.column.slide-in-right[.content.vmiddle[
.sliderbox.shade_main.pad1[
.font5[.center[Interface gráfica do RStudio - aba Git]]
]
]]
---
class: middle
...
O RStudio oferece um cliente Git simples, na aba "Git". 
